...
const s = StyleSheet.create({
  ...
  fabWrap:          { position:'absolute', bottom:4, left:0, right:0, alignItems:'center', zIndex:20 },
  ...
  fabPlus:          { color:'#fff', fontSize:22, fontWeight:'900', lineHeight:24 },
  fabLabel:         { color:'#fff', fontSize:10, fontWeight:'700', textAlign:'center', lineHeight:12 },
