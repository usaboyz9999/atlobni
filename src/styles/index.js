...
export const STATUS_H = Platform.OS === 'android' ? (StatusBar.currentHeight || 24) : 44;
export const NAV_H    = 64;
export const SAFE_BOTTOM = Platform.OS === 'android' ? 24 : 0; // لـ navigation bar
...
const s = StyleSheet.create({
  ...
  cartFooter:       { backgroundColor:'#fff', borderTopWidth:1, borderTopColor:'#DDE4EF', padding:16, paddingBottom:16+SAFE_BOTTOM },
  ...
  modalContainer:   { backgroundColor:'#fff', borderTopLeftRadius:24, borderTopRightRadius:24, maxHeight:'90%', paddingBottom:SAFE_BOTTOM },
  ...
  // ── Bottom Nav ───────────────────────────────────────────────
  bottomNavWrapper: { position:'relative', backgroundColor:'#fff', paddingBottom:SAFE_BOTTOM },
  ...
  fabWrap:          { position:'absolute', bottom:NAV_H/2+SAFE_BOTTOM/2, left:0, right:0, alignItems:'center', zIndex:20 },
